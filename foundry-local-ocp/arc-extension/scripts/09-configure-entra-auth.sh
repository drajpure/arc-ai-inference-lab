...
echo ""
echo "  Extension install with Entra auth:"
echo "    Set ENTRA_APP_CLIENT_ID in env.sh, then run 05-install-extension.sh"
echo "    The script passes entraAuth.clientId and entraAuth.tenantId automatically."
echo "================================================================"
